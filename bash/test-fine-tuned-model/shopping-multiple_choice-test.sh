...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch --main_process_port 6666 \
    ...
    --model_name_or_path Yi-9B-sft \
    --stage sft \
    --do_predict true \
    --dataset shopping-multiple_choice-test \
    --dataset_dir LLaMA-Factory/LLaMA-Factory-main/data \
    --template default \
    --output_dir Yi-9B-sft/shopping-multiple_choice-test \
