...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 accelerate launch --main_process_port 8888 \
    ...
    --lora_dropout 0.08 \
    --lora_rank 4 \
    --output_dir LLaMA-Factory/LLaMA-Factory-main/saves/Yi-9B/post-pt-1 \
